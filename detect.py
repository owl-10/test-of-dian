...
def detect(save_img=False):
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in det:
                    if save_txt:  # Write to file
                        ...
                        cls = torch.as_tensor(cls).tolist()
                        conf = torch.as_tensor(conf).tolist()
                        # print(cls)
    ...
    sub.to_csv('submission-yolov5l2.csv', index=False)
    with open("yolov5l1.json", "w") as f:
        json.dump(result, f)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/best3.pt', help='model.pt path')
