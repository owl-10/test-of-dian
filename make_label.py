...
train_annotation_path = 'D:/python/yolov5-master/yolov5-master/input/mchar_train.json'
val_annotation_path = 'D:/python/yolov5-master/yolov5-master/input/mchar_val.json'
train_data = json.load(open(train_annotation_path))
val_data = json.load(open(val_annotation_path))
label_path = 'D:/python/yolov5-master/datasets/coco128/labels/tianchilabels/'
